    ...
    <div className="space-y-6" style={{ fontFamily: 'Inter' }}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Inter' }}>Add New Farm Manager</h1>
            <p className="text-gray-600" style={{ fontFamily: 'Inter' }}>Register a new Farm Manager in the system</p>
          </div>
        </div>
      </div>

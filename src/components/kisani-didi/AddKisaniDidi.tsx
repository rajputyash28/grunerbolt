    ...
    <div className="space-y-6" style={{ fontFamily: 'Poppins' }}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Poppins' }}>Add New Kisani Didi</h1>
            <p className="text-gray-600" style={{ fontFamily: 'Poppins' }}>Register a new Kisani Didi in the system</p>
          </div>
        </div>
      </div>

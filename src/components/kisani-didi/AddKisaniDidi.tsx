    ...
    <div className="space-y-6" style={{ fontFamily: 'Inter' }}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Inter' }}>Add New Kisani Didi</h1>
            <p className="text-gray-600" style={{ fontFamily: 'Inter' }}>Register a new Kisani Didi in the system</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" style={{ fontFamily: 'Inter' }}>Languages Known</label>
              <input
                type="text"
                name="languages"

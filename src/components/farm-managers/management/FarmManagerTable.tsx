...
interface FarmManagerTableProps {
  ...
  handleViewProfile: (manager: FarmManager) => void;
  handleViewPendingProfile: (approval: PendingApproval) => void;
  showActionMenu: number | null;
  actionMenuRef: React.RefObject<HTMLDivElement>;
  toggleActionMenu: (managerId: number, e: React.MouseEvent) => void;
  handleEdit: (manager: FarmManager) => void;
  handleDelete: (managerId: number) => void;
  handleBlock: (managerId: number) => void;

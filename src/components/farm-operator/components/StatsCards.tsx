...
const StatsCards: React.FC<StatsCardsProps> = ({ totalOperators, pendingApprovals }) => {
  return (
      ...
      <div className="bg-white border border-gray-200 rounded-xl" style={{ 
        ...
        <div className="flex items-center gap-3 p-6">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Inter' }}>{totalOperators}</p>
          </div>
        </div>
      </div>
      <div className="bg-white border border-gray-200 rounded-xl" style={{ 
